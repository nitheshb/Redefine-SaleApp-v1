...
import 'package:erp/auth/authenticate.dart';
import 'package:erp/lead_data/leadpage.dart';
import 'package:erp/logs.dart';
...
class _MyHomePageState extends State<MyHomePage> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // ),
      appBar: AppBar(
          backgroundColor: Colors.teal[200], title: Text("Redifine ERP")),
      body: Container(
